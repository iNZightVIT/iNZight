...
* create new `iNZWindow` 'superclass' to make it easier to create consistent pop-up windows (#375, @tmelliott)
* create new `iNZFilterWin` to replace broken `iNZSaveWin` (#374, @tmelliott)
