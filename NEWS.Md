...
* fix bug in *File* > *Reload* causing crash if data hadn't been loaded yet (#332, @tmelliott)
* disable *Identify Points* for hexbin/grid plots and histograms (#326, @tmelliott)
