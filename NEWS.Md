* refactor of the Aggregate Data functionality
  * allows users to select more than three variables and to perform aggregation over a subset of variables
  * implements code history for this operation
